    ...
    const fetchCourseLandingData = async () => {
      try {
        ...
        setFormData({
          ...
          thumbnailImage: null,
          videoFile: null,
          seats: data.seats !== null && data.seats !== undefined ? String(data.seats) : '',
        });
  ...
  return (
    <div className="component-container">
      ...
      <div className="content">
        ...
        <p><strong>Limit Your Seats (Optional)</strong></p>
        <div className="flex gap-6">
          <div className="field-container">
            <input
              type="number"
              id="seats"
              placeholder="Enter available number of seats"
              className="border rounded p-2 max-w-[500px] max-h-[50px]"
